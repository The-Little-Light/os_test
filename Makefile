...
OBJS = $(BUILD_DIR)/main.o $(BUILD_DIR)/init.o $(BUILD_DIR)/interrupt.o \
	  ...
	  $(BUILD_DIR)/buildin_cmd.o $(BUILD_DIR)/exec.o  $(BUILD_DIR)/assert.o $(BUILD_DIR)/wait_exit.o\
	  $(BUILD_DIR)/pipe.o
...
$(BUILD_DIR)/shell.o: shell/shell.c shell/shell.h kernel/global.h lib/stdint.h lib/string.h \
	lib/user/syscall.h lib/stdio.h fs/file.h kernel/debug.h  fs/fs.h
	$(CC) $(CFLAGS) $< -o $@
...
$(BUILD_DIR)/exec.o: userprog/exec.c userprog/exec.h fs/file.h fs/fs.h kernel/debug.h \
	lib/string.h lib/stdio.h thread/thread.h kernel/memory.h 
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/assert.o: lib/user/assert.c lib/user/assert.h lib/stdio.h lib/stdint.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/wait_exit.o: userprog/wait_exit.c userprog/wait_exit.h thread/thread.h \
	kernel/global.h lib/stdint.h kernel/memory.h kernel/interrupt.h lib/kernel/list.h \
	kernel/debug.h
	$(CC) $(CFLAGS) $< -o $@

$(BUILD_DIR)/pipe.o: shell/pipe.c shell/pipe.h lib/stdint.h kernel/global.h thread/thread.h 
	$(CC) $(CFLAGS) $< -o $@
